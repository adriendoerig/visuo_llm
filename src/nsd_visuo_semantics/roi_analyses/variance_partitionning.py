...
var_components_save_file = os.path.join(f"./variance_components_{rdm_distance}_zscore.npy")
...
def variance_partitioning(y, predictors_features, predictors_names, zscore=True):
    ...
    for combo in all_combinations:
        ...
        # model = frr.fit(X, y, frac_grid=fracs)
        models[combo] = model
