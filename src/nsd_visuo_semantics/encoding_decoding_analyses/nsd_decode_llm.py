...
from nsd_visuo_semantics.utils.nsd_get_data_light import get_conditions, get_conditions_100, get_conditions_515, get_1000, get_rois,get_sentence_lists, load_or_compute_betas_average, make_515_embeddings



NOT FINISHED REWORKING THIS
...
def nsd_decode_llm(EMBEDDING_MODEL_NAME, USE_ROIS, WHICH_ROIS, METRIC, PREDICT_X_FROM_Y, GCC_DIR):
